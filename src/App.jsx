          ...
          {ANIME_LIST.map((data, idx) => {
            ...
            return (
              <div
                ...
                className="group cursor-pointer bg-white/5 backdrop-blur-sm rounded-xl overflow-hidden hover:-translate-y-2 transition-all duration-300 relative flex flex-col aspect-3/4 [@media(hover:none)]:transform-none"
